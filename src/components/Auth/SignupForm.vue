    ...
    <div class="w-full max-w-md text-center">
      ...
      <form novalidate @submit.prevent="handleSubmit">
        ...
        <div class="relative mt-4xl">
          ...
          <p v-if="errors.password" class="label_2_semibold text-error-600 mt-md flex gap-sm">
            <img :src="WarningIcon" alt=""> {{ errors.password }}
          </p>
        </div>

        <div>
          <label class="body_3_regular flex items-start gap-md mt-6xl">
            <input
              type="checkbox"
              v-model="form.terms"
...
const handleSubmit = async () => {
  ...
  if (!form.password) {
    ...
    errors.password = "Oops! The password you entered is incorrect."
    isValid = false
  }
  ...
  try {
    ...
    submitError.value = "Unable to create account. Please try again."
  } finally {
